    ...
    protected function deleteuser()
    {
        ...
        if ($id > 0) {
            ...
            if ($delete > 0) {
                ...
                $response_array['message'] = 'Total ' . $delete . ' record(s) Deleted.';
                $response_array['data'] = $delete;
                $this->response(json_encode($response_array), 200);
            } else {
